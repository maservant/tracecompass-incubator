...
public class ActivatorTest extends Plugin {
     ...
     * The plug-in ID
     */
    public static final String PLUGIN_ID = "org.eclipse.tracecompass.incubator.lsp.core.tests"; //$NON-NLS-1$
    ...
    public void testActivator() {
        ...
        assertEquals("org.eclipse.tracecompass.incubator.lsp.core", instance.getPluginId());
    }
